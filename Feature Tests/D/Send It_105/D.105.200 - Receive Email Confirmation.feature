Feature: Send It: D.105.200 - The system shall support the ability to receive email confirmation of file download from the user/users.
  ...
  Scenario: D.105.200 - Received Email Confirmation
    ...
    And I copy and paste the password for user "dave@abc.com" from the email with subject "Re: [REDCap Send-It] Send-it file" to the link in the email with subject "[REDCap Send-It] Send-it file"
    ...
    And I click on link in the email with subject "[REDCap Send-It] Send-it file" for user "dave@abc.com" after 4 days
