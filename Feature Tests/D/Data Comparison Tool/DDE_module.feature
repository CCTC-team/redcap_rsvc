Feature: Data Comparison Tool / DDE Module
  ...
  Scenario: Project Setup 1 - Create Project 17_DataComparisonTool_DDE_v1115
    ...
    And I create a new project named "D.4.17" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "Project_1.xml", and clicking the "Create Project" button
