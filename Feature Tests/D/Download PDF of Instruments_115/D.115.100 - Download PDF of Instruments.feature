Feature: D.115.100 - The system shall support the ability to download the PDF of instruments 
  ...
  Scenario: D.115.100 - Download PDF of Instruments
    ...
    Then I create a new project named "D.115.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "/redcap_val_cdisc_files/Project_redcap_val.xml", and clicking the "Create Project" button
