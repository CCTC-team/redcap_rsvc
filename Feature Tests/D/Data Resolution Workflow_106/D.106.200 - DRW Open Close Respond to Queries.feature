Feature: D.106.200 - The system shall support the ability to open, close, reopen and respond to queries.
      ...
      Scenario: D.106.300 - Filtering
            ...
            # When I select the option "Open / unresolved issues (1)" from the dropdown field for Field Rule in Data Resolution Dashboard
            # Then I should see a table header and row containing the following values in a table:
            ...
            # When I select the option "Test_User1 (Test_User1)" from the dropdown field for Assigned User in Data Resolution Dashboard
            # Then I should see "No results to display"

            # When I select the option "All field" from the dropdown field for Field Rule in Data Resolution Dashboard
            #       | Record                        | Data Quality rule and/or Field  | User Assigned  | First Update                             | Last Update                             |
            #       | 2 (#1) Event 1 (Arm 1: Arm 1) | ptname (Name)                   | Test_User1     | Test_User2 (mm/dd/yyyy hh:mm): "Query 2" | [same as first update]                  |
