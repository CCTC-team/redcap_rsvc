Feature: D.122.100 - The system shall provide the ability to reassign a record from one DAG to another for users with appropriate user rights

  As a REDCap end user
  I want to see that reassign a record from one DAG to another works as expected.

  Scenario: D.122.100 - Reassign a record from one DAG to another
    Given I login to REDCap with the user "Test_Admin"
    And I create a new project named "D.122.100" by clicking on "New Project" in the menu bar, selecting "Practice / Just for fun" from the dropdown, choosing file "redcap_val/D122100.xml", and clicking the "Create Project" button
    ...
    And I click on the link labeled "D.122.100"
