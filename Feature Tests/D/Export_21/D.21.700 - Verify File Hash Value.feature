Feature: D.21.700 - Verify hash value of the exported file formats: CSV, SPSS, SAS, R, STATA, and CDISC ODM (XML).
  ...
  Scenario: B.5.21.200.100 Export data format
    ...
    And I click on the button labeled "Close" in the dialog box
    And I should have the latest downloaded "sas" file with SHA256 hash value "e23a6053e9dfe4b96a0c3cf7409a88466d3c281e7878b2783ebe9cc57a505f66"
    ...
    And I click on the button labeled "Close" in the dialog box
    And I should have the latest downloaded "r" file with SHA256 hash value "58d68b59cec4c297e6d886b293437c54fbfb5dde100e175a25d17257aada5a52"
    ...
    And I click on the button labeled "Close" in the dialog box
    And I should have the latest downloaded "do" file with SHA256 hash value "5845eea57e88483b5ef9a02a468f24b938457b1af650f79054372d1cc2daff56"
    ...
    And I click on the button labeled "Close" in the dialog box
    And I should have the latest downloaded "xml" file with SHA256 hash value "4b6c098f9779a781abe8ffbf453b1c4d20e355d460f13d24113534d167a40a7d"
    And I logout